...
| 8 | Distribution for earned mentions | Agent (drafts), Travis/human (posts) | Agent emits `editorial/distribution/<slug>.md` with ready-to-paste Reddit/X/Discord/Telegram copy per post |
